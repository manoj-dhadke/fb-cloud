...
# begin
@log.trace("Started execution 'fb-cloud:vmware55:operation:reboot_virtual_machines.rb") # execution Started
begin
...
@log.trace("Finished execution of 'fb-cloud:vmware55:operation:reboot_virtual_machines.rb' flintbit...")
# end
