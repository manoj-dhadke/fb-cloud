// begin
log.trace("Started execution 'fb-cloud:vmware55:operation:list_virtual_machines.groovy' flintbit...") // execution Started
try{
...
log.trace("Finished execution 'fb-cloud:vmware55:operation:list_virtual_machines.groovy' flintbit...")
// end
