# begin
@log.trace("Started execution 'fb-cloud:vmware55:operation:modify_virtual_machine_cpu.rb' flintbit...") # execution Started
begin
	# Flintbit input parametes
	# Mandatory
	@connector_name = @input.get('connector_name') # vmware connector name
	@action ='modify-cpu' # name of the operation:modify-cpu
	...
	@number_of_cpu=@input.get('number-of-cpu') #number of cpu which you are going to update for given virtual machine
	...
	if @number_of_cpu.nil?
		raise 'Please provide "virtual machine number of cpu (@number_of_cpu)" to update virtual machine'
	end
	...
	connector_call = @call.connector(@connector_name)
		    ...
		    .set('vm-name', @vm_name)
                    .set('number-of-cpu', @number_of_cpu)
...
@log.trace("Finished execution 'fb-cloud:vmware55:operation:modify_virtual_machine_cpu.rb' flintbit...")
# end
