 ...
 */
log.trace("Started execution 'fb-cloud:vmware55:operation:details_virtual_machines.groovy' flintbit...") // execution Started
try{
    ...
    if (connector_name == null || connector_name == ""){
        throw new Exception('Please provide "VMWare connector name (connector_name)" to retrieve  details of virtual machines') 
    }
    ...
    // VMWare  Connector Response Meta Parameterss
     ...
     response_message =  response.message() // Execution status message
      ...
      if (response_exitcode==0){
         ...
         output.set("result",response.toString()).set('exit-code',0).set('message',"success")
      }
      else{
...
log.trace("Finished execution 'fb-cloud:vmware55:operation:details_virtual_machines.groovy' flintbit...")
//end
