// begin
log.trace("Started execution 'fb-cloud:vmware55:operation:reboot_virtual_machines.groovy") // execution Started
try{
  // Flintbit input parametes
   ...
   if (connector_name == null || connector_name == ""){
        throw new Exception( 'Please provide "VMWare connector name (connector_name)" to reboot virtual machines')
   }

     //checking virtual machine name is nil or empty
    if (vmname == null || vmname == ""){
        throw new Exception( 'Please provide "Virtual Machine name (vmname)" to reboot virtual machine')
    }
    else{
...
log.trace("Finished execution of 'fb-cloud:vmware55:operation:reboot_virtual_machines.groovy' flintbit...")
// end
