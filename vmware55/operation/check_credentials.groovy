 ...
 */
log.trace("Started execution 'fb-cloud:vmware55:operation:check_credential.groovy' flintbit...") // execution Started
try{
...
log.trace("Finished execution 'fb-cloud:vmware55:operation:check_credential.groovy' flintbit...")
// end