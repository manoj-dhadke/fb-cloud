# begin
@log.trace("Started execution 'fb-cloud:vmware55:operation:rename_virtual_machine.rb' flintbit...") # execution Started
begin
	...
	if @new_name.nil?
		raise 'Please provide "virtual machine new name (@new_name)" to update virtual machine'
	end
...
@log.trace("Finished execution 'fb-cloud:vmware55:operation:rename_virtual_machine.rb' flintbit...")
# end
