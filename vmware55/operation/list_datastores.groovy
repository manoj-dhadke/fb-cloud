 ...
 */
log.trace("Started execution 'fb-cloud:vmware55:operation:list_datastores.groovy' flintbit...") // execution Started
try{

    // Flintbit Input Parameters
    // Mandatory
    connector_name = input.get('connector_name') // vmware55 connector name
    action = 'list-datastores' // name of action:list-vm
...
log.trace("Finished execution 'fb-cloud:vmware55:operation:list_datastores.groovy' flintbit...")
// end
