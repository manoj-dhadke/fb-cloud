...
@log.trace("Started executing 'fb-cloud:aws-s3:operation:create_bucket.rb' flintbit...")
begin
	...
	if @bucket_name.nil? || @bucket_name.empty?
		raise 'Please provide "name of bucket (bucket-name)" to create bucket on aws-s3'
	end
...
@log.trace("Finished executing 'fb-cloud:aws-s3:operation:create_bucket.rb' flintbit")
