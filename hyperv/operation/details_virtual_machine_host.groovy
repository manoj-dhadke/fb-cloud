 ...
 */
log.trace("Started executing 'fb-cloud:hyperv:operation:details_virtual_machine_host.groovy' flintbit...")
try{ 
    ...
    log.info("Flintbit input parameters are,  connector name :: ${connector_name} | target :: ${target} | username :: ${username} | password ::  ${password} | shell :: ${shell} | vmidentifier :: ${vmidentifier} | transport :: ${transport} | command :: ${command} | operation_timeout :: {operation_timeout} | no_ssl_peer_verification :: ${no_ssl_peer_verification} | port :: ${port}  | timeout :: ${request_timeout}")
...
log.trace("Finished executing 'fb-cloud:hyperv:operation:details_virtual_machine_host.groovy' flintbit...")
//end
