 ...
 */
log.trace("Started executing 'fb-cloud:hyperv:operation:shutdown_virtual_machine.groovy' flintbit...")
try{
    ...
    command = "\$VM = Get-VM -Id ${vmidentifier};Stop-VM -VM \$VM -TurnOff 2>&1 | convertto-json"              //Command to run
...
log.trace("Finished executing 'fb-cloud:hyperv:operation:shutdown_virtual_machine.groovy' flintbit...")
//end
