...
require 'rubygems'
#begin
@log.trace("Started executing 'flint-hyperv:hyperv_2012:delete_virtual_machine.rb' flintbit...")
begin
#Flintbit Input Parameters
#Mandatory
@connector_name= @input.get("connector_name")											#Name of the Connector
@vmname = @input.get("vmname")															#Name of the vm
@command = "powershell -Command \"&{Remove-VM #{@vmname} -f 2>&1 | ConvertTo-JSON}\"" #Command to execute
...
@log.trace("Finished executing 'flint-hyperv:hyperv_2012:delete_virtual_machine.rb' flintbit...")
#end
