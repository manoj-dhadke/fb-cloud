 ...
 */
log.trace("Started executing 'fb-cloud:hyperv:operation:pause_virtual_machine.groovy' flintbit...")
try{
    ...
    command = "\$VM = Get-VM -Id ${vmidentifier};Suspend-VM -VM \$VM  2>&1 | convertto-json"           //Command to run
...
log.trace("Finished executing 'fb-cloud:hyperv:operation:pause_virtual_machine.groovy' flintbit...")
//end
