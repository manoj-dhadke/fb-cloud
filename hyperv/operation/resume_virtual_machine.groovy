 ...
 */
log.trace("Started executing 'fb-cloud:hyperv:operation:resume_virtual_machine.groovy' flintbit...")
try{
    ...
    command = "\$VM = Get-VM -Id ${vmidentifier};Resume-VM -VM \$VM  2>&1 | convertto-json"           //Command to run
    ...
    if (vmidentifier == null || vmidentifier == ""){
            log.error("Please provide vm id to perform resume operation")
...
log.trace("Finished executing 'fb-cloud:hyperv:operation:resume_virtual_machine.groovy' flintbit...")
//end
