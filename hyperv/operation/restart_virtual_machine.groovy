...
//require 'rubygems'
//begin
log.trace("Started executing 'fb-cloud:hyperv:operation:restart_virtual_machine.groovy' flintbit...")
try{
    ...
    command = "\$VM = Get-VM -Id ${vmidentifier};Restart-VM -VM \$VM -Force  2>&1 | convertto-json"           //Command to run
...
log.trace("Finished executing 'fb-cloud:hyperv:operation:restart_virtual_machine.groovy' flintbit...")
//end
