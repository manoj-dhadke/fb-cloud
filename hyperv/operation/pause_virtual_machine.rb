...
require 'rubygems'
#begin
@log.trace("Started executing 'fb-cloud:hyperv:operation:pause_virtual_machine.rb' flintbit...")
begin
...
@log.trace("Finished executing 'fb-cloud:hyperv:operation:pause_virtual_machine.rb' flintbit...")
#end
