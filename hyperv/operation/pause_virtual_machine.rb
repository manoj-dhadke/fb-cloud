...
require 'rubygems'
#begin
@log.trace("Started executing 'flint-hyperv:hyperv_2012:pause_virtual_machine.rb' flintbit...")
begin
...
@log.trace("Finished executing 'flint-hyperv:hyperv_2012:pause_virtual_machine.rb' flintbit...")
#end
