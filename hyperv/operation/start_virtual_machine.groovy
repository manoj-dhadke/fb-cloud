...
//require 'rubygems'
//begin
log.trace("Started executing 'fb-cloud:hyperv:operation:start_virtual_machine.rb' flintbit...")
try{
    ...
    command = "\$VM = Get-VM -Id ${vmidentifier};Start-VM -VM \$VM  2>&1 | convertto-json"                    //Command to run
...
log.trace("Finished executing 'fb-cloud:hyperv:operation:start_virtual_machine.rb' flintbit...")
//end
