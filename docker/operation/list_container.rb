#begin
@log.trace("Started execution 'fb-cloud:docker:operation:list_container.rb' flintbit...") # execution Started
begin
	# Flintbit input parametes
	#Mandatory
	@connector_name = @input.get('connector_name') # docker connector name
	@action = 'list-containers' # name of the operation: list-container
	...
	if @connector_name.nil? || @connector_name.empty?
		raise 'Please provide "Docker connector name (@connector_name)" to list container'
	end
...
@log.trace("Finished execution 'fb-cloud:docker:operation:list_container.rb' flintbit...")
#end
