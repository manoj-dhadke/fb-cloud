# begin
begin
    @log.trace("Started executing 'fb-cloud:digitalocean:operation:describe_instance.rb' flintbit...")
...
@log.trace("Finished executing 'fb-cloud:digitalocean:operation:describe_instance.rb' flintbit...")
# end
