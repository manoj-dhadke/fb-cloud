...
# begin
@log.trace("Started executing 'fb-cloud:digitalocean:operation:list_regions.rb' flintbit...")
begin
...
@log.trace("Finished executing 'fb-cloud:digitalocean:operation:list_regions.rb' flintbit...")
# end
