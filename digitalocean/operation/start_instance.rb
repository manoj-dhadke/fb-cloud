...
# begin
@log.trace("Started executing 'fb-cloud:digitalocean:operation:start_instance.rb' flintbit...")
begin
...
@log.trace("Finished executing 'fb-cloud:digitalocean:operation:start_instance.rb' flintbit...")
# end
