# begin
@log.trace("Started executing 'fb-cloud:aws-ec2:operation:create_tags.rb' flintbit...")
begin
...
@log.trace("Finished executing 'fb-cloud:aws-ec2:operation:create_tags.rb' flintbit")
# end
