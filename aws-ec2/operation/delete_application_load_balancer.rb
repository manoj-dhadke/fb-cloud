# begin
@log.trace("Started executing 'fb-cloud:aws-ec2:operation:delete_application_load_balancer.rb' flintbit...")
begin
    # Flintbit Input Parameters
    # Mandatory
    connector_name = @input.get('connector_name') # Name of the Amazon EC2 Connector
    name = @input.get('name') #Specifies name of load balancer to be deleted
    action = "delete-application-load-balancer" # Specifies the name of the operation:delete-subnet
    ...
    if name.nil? || name.empty?
        raise 'Please provide "Name of load balancer" to delete subnet'
    end
...
@log.trace("Finished executing 'fb-cloud:aws-ec2:operation:delete_application_load_balancer.rb' flintbit")
# end
