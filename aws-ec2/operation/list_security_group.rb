# begin
@log.trace("Started executing 'fb-cloud:aws-ec2:operation:list_security_group.rb' flintbit...")
...
if response_exitcode == 0
    ...
    @output.setraw('security-group-list', security_group_list.to_s)
else
    @log.error("ERROR in executing #{connector_name} where, exitcode : #{response_exitcode} |message : #{response_message}")
    @output.set('error', response_message)
    # @output.exit(1,response_message)						#Use to exit from flintbit
end
@log.trace("Finished executing 'fb-cloud:aws-ec2:operation:list_security_group.rb' flintbit")
# end
