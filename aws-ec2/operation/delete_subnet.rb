# begin
@log.trace("Started executing 'fb-cloud:aws-ec2:operation:delete_subnet.rb' flintbit...")
begin
	# Flintbit Input Parameters
	# Mandatory
	connector_name =@input.get('connector_name')# Name of the Amazon EC2 Connector
	action = 'delete-subnet'	# Specifies the name of the operation:list-subnets
	subnet_id = @input.get('subnet-id')	# Specifies the  subnet-id which you are going to delete
	...
	if connector_name.nil? || connector_name.empty?
		raise 'Please provide "Amazon EC2 connector name (connector_name)" to delete subnet'
	end
	...
	if subnet_id.nil? || subnet_id.empty?
		raise 'Please provide "Amazon EC2 subnet id (subnet_id)" to delete subnet'
	end
...
@log.trace("Finished executing 'fb-cloud:aws-ec2:operation:delete_subnet.rb' flintbit")
# end
