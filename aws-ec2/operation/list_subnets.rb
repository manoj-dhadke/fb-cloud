# begin
@log.trace("Started executing 'fb-cloud:aws-ec2:operation:list_subnets.rb' flintbit...")
begin
	...
	if connector_name.nil? || connector_name.empty?
		raise 'Please provide "Amazon EC2 connector name (connector_name)" to list subnet'
	end
