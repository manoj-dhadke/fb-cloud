...
# begin
@log.trace("Started executing 'fb-cloud:aws-ec2:operation:list_images.rb' flintbit...")
begin
...
@log.trace("Finished executing 'fb-cloud:aws-ec2:operation:list_images.rb' flintbit")
# end
