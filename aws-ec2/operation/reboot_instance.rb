#begin
@log.trace("Started executing 'flint-cloud:aws-ec2:operation:reboot_amazon_instance.rb' flintbit...")
begin
...
if response_exitcode == 0
	...
	@log.trace("Finished executing 'flint-cloud:aws-ec2:operation:reboot_amazon_instance.rb' flintbit")
#end
