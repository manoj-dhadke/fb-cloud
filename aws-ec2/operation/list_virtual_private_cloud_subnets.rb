# begin
@log.trace("Started executing 'fb-cloud:aws-ec2:operation:list_virtual_private_cloud_subnets.rb' flintbit...")
begin
	...
	if connector_name.nil? || connector_name.empty?
		raise 'Please provide "Amazon EC2 connector name (connector_name)" to list virtual private cloud subnet'
	end
	...
	if vpc_id.nil? || vpc_id.empty?
		raise 'Please provide "Amazon EC2 Vpc id (vpc_id)" to list virtual private cloud subnet'
	end
	...
	subnet_list = response.get('subnet-list')	# Set of Amazon EC2 virtual private cloud subnets
	...
	if response_exitcode == 0
		...
		@log.info("subnet-list:-#{subnet_list}")
