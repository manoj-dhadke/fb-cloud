# begin
@log.trace("Started executing 'fb-cloud:aws-ec2:operation:start_amazon_instance.rb' flintbit...")
begin
...
@log.trace("Finished executing 'fb-cloud:aws-ec2:operation:start_amazon_instance.rb' flintbit")
# end
