# begin
@log.trace("Started executing 'flint-cloud:aws-ec2:operation:start_amazon_instance.rb' flintbit...")
begin
...
@log.trace("Finished executing 'flint-cloud:aws-ec2:operation:start_amazon_instance.rb' flintbit")
# end
