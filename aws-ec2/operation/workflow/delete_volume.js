 ...
 * Summary: To Delete Volume
 * Description: To delete Volume on AWS EC2 using aws-ec2 connector
 */

log.trace("Started executing the flintbit 'fb-cloud:aws-ec2:operation:workflow:delete_volume.js'");
...
if(input_scope.hasOwnProperty("cloud_connection")){
    ...
    if(response_exitcode==0){
        ...
        user_message = "Volume Deleted Successfully";
        output.set("message",response_message)
            .set("exit-code",response_exitcode)
            .set("user_message",user_message);
        log.trace("Finished executing 'fb-cloud:aws-ec2:operation:workflow:delete_volume.js' successfully");
    }
    else{
        log.error("Failure in execution, message:"+response_message+" | exitcode:"+response_exitcode);
        output.set("error",response_message).set("exit-code",-1);
        log.trace("finished executing 'fb-cloud:aws-ec2:operation:workflow:delete_volume.js' with errors")
    }
