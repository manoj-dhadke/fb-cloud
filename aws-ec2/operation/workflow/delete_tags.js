 ...
 * Summary: To delete tags on AWS
 * Description: To delete tags on AWS using aws-ec2 connector
 */

log.trace("Started executing the flintbit 'fb-cloud:aws-ec2:operation:workflow:delete_tags.js'");
...
if(input_scope.hasOwnProperty("cloud_connection")){
    ...
    if(response_exitcode==0){
        ...
        output.set("user_message","Tags Deleted Successfully")
            .set("exit-code",response_exitcode)
            .set("message",response_message);
        log.trace("Finished executing the flintbit 'fb-cloud:aws-ec2:operation:workflow:delete_tags.js' successfully");
    }
    else{
        log.error("Failure in execution, message:"+response_message+" | exitcode:"+response_exitcode);
        output.set("error",response_message).set("exit-code",-1);
        log.trace("finished executing 'fb-cloud:aws-ec2:operation:workflow:delete_tags.js' with errors")
    }
}
