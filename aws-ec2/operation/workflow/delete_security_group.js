 ...
 * Summary: To delete security group on AWS
 * Description: To delete security group using aws-ec2 connector
 */

log.trace("Started executing the flintbit 'fb-cloud:aws-ec2:operation:workflow:delete_security_group.js'");
...
if(input_scope.hasOwnProperty("cloud_connection")){
    ...
    if(input_scope.hasOwnProperty("group_id")){
        ...
        log.info("Input does not contain the key 'group_id'")
    }
    ...
    if(response_exitcode==0){
        log.info("Successfully deleted a Security Group");
        ...
        log.trace("Finished executing 'fb-cloud:aws-ec2:operation:workflow:delete_security_group.js' successfully");
    }
    else{
        log.error("Failure in execution, message:"+response_message+" | exitcode:"+response_exitcode);
        output.set("error",response_message).set("exit-code",-1);
        log.trace("finished executing 'fb-cloud:aws-ec2:operation:workflow:delete_security_group.js' with errors")
    }
}
