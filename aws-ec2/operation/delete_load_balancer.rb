# begin
@log.trace("Started executing 'fb-cloud:aws-ec2:operation:delete_load_balancer.rb' flintbit...")
begin
...
@log.trace("Finished executing 'fb-cloud:aws-ec2:operation:delete_load_balancer.rb' flintbit")
# end
