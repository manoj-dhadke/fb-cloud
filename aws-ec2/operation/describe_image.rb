#begin
@log.trace("Started executing 'flint-cloud:aws-ec2:operation:describe_image.rb' flintbit...")
begin
...
@log.trace("Finished executing 'flint-cloud:aws-ec2:operation:describe_image.rb' flintbit")
#end
