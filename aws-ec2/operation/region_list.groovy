 ...
 */
log.trace("Started executing 'fb-cloud:aws-ec2:operation:region_list.groovy' flintbit...")
try{
    // Flintbit Input Parameters
    // Mandatory
    log.info('REGION LIST INPUT --> ' + input.raw.toString())
    ...
    if (response_exitcode == 0){
        ...
        output.set('exit-code', 0).set('message', 'success').setraw('region', region_set.toString())
    }
    else{
...
log.trace("Finished executing 'fb-cloud:aws-ec2:operation:region_list.groovy' flintbit")
// end
