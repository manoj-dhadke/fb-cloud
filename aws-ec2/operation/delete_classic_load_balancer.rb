...
# begin
@log.trace("Started executing 'fb-cloud:aws-ec2:operation:delete_classic_load_balancer.rb' flintbit...")
begin
    # Flintbit Input Parameters
    # Mandatory
    connector_name = @input.get('connector_name') # Name of the Amazon EC2 Connector
    name = @input.get('name') #Specifies name of load balancer to be deleted
    action = "delete-classic-load-balancer" # Specifies the name of the operation:delete-subnet
    # Optional
...
@log.trace("Finished executing 'fb-cloud:aws-ec2:operation:delete_classic_load_balancer.rb' flintbit")
# end
