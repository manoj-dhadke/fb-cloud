 ...
 */
log.trace("Started execution 'fb-cloud:google-cloud:operation:start_instance.groovy' flintbit...") // execution Started
try{
    // Flintbit input parametes
    // Mandatory
    connector_name = input.get('connector_name') // google-cloud connector name
    action = "start-instance" // name of the operation: start-instance
    ...
    if (connector_name == null || connector_name == ""){
       throw new Exception ( 'Please provide "google-cloud connector name (connector_name)" to start instance')
    }

    //checking project-id is nil or empty
    if( project_id == null || project_id == ""){
       throw new Exception ( 'Please provide "Please provide project id (project-id)" to start instance')
    }
    else{
    ...
    if( zone_name == null || zone_name == ""){
       throw new Exception ( 'Please provide "Please provide zone name(zone-name)" to start instance')
    }
    else{
  ...
  //checking service-account-credentials is nil or empty
    if( service_account_credenetials == null || service_account_credenetials == ""){
       throw new Exception ( 'Please provide "Please provide service account credentials (service-account-credentials)" to start instance')
    }
    else{
  ...
  //checking instance name is nil or empty
    if( instance_name == null || instance_name == ""){
       throw new Exception ( 'Please provide "Please provide instance name (insatnce-name)" to start instance')
    }
    else{
...
log.trace("Finished execution 'fb-cloud:google-cloud:operation:start_instance.groovy' flintbit...")
// end
