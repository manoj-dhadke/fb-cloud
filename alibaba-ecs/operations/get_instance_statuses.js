...
log.trace("Started executing fb-cloud:alibaba-ecs:operations:get_instance_statuses.js flintbit")

log.trace("Inputs :: " + input)
action = "list-instance-status"
...
if (exit_code == 0) {
    log.trace("Instances list :: \n" + connector_call_response.get('status-list'))
    output.set('user_message', connector_call_response.get('status-list'))
    output.set('message', message)
    output.set('result', connector_call_response.get('status-list'))
...
log.trace("Finished executing fb-cloud:alibaba-ecs:operations:get_instance_statuses.js flintbit")
