...
# begin
@log.trace("Started execution 'fb-cloud:vmware-vcd:operation:start_virtual_machine.rb' flintbit...") # execution Started
begin
...
@log.trace("Finished execution 'fb-cloud:vmware-vcd:operation:start_virtual_machine.rb' flintbit...")
# end
