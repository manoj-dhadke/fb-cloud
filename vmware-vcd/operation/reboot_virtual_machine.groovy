...
// begin
log.trace("Started execution 'fb-cloud:vmware-vcd:operation:reboot_virtual_machine.groovy' flintbit...") // execution Started
try{
...
log.trace("Finished execution 'fb-cloud:vmware-vcd:operation:reboot_virtual_machine.groovy' flintbit...")
// end