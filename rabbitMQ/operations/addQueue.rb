	...
	@log.trace("Started execution of 'fb-cloud:rabbitMQ:operations:addQueue.rb' flintbit..")
begin
	...
	@log.trace("Finished execution of 'fb-cloud:rabbitMQ:operations:addQueue.rb' flintbit..")