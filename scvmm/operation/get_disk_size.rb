...
require 'rubygems'
#begin
@log.trace("Started executing 'fb-cloud:scvmm:operation:get_disk_size.rb' flintbit...")
begin
    ...
    @command = "Get-SCVirtualHardDisk -VM #{@vmidentifier} 2>&1"          #Command to run
...
@log.trace("Finished executing 'fb-cloud:scvmm:operation:get_disk_size.rb' flintbit...")
#end
