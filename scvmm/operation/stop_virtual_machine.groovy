...
//begin
log.trace("Started executing 'fb-cloud:scvmm:operation:stop_virtual_machine.groovy' flintbit...")
try{
    ...
    command = "$VM = Get-SCVirtualMachine -Id  ${vmidentifier} -VMMServer ${target};Stop-SCVirtualMachine -VM $VM | convertto-json"   //Command to run
...
log.trace("Finished executing 'fb-cloud:scvmm:operation:stop_virtual_machine.groovy' flintbit...")
//end