...
require 'rubygems'
#begin
@log.trace("Started executing 'fb-cloud:scvmm:list_virtual_machine.rb' flintbit...")
begin
    ...
    @command = "Get-SCVirtualMachine -All 2>&1 | convertto-json"                                 #Command to run
...
@log.trace("Finished executing 'fb-cloud:scvmm:list_virtual_machine.rb' flintbit...")
#end
