...
require 'rubygems'
#begin
@log.trace("Started executing 'fb-cloud:scvmm:operation:details_virtual_machine_host.rb' flintbit...")
begin  
...
@log.trace("Finished executing 'fb-cloud:scvmm:operation:details_virtual_machine_host.rb' flintbit...")
#end
