...
require 'rubygems'
#begin
@log.trace("Started executing 'fb-cloud:scvmm:operation:resume_virtual_machine.rb' flintbit...")
begin
    ...
    @command = "$VM = Get-SCVirtualMachine -Id  #{@vmidentifier} -VMMServer #{@target};Resume-SCVirtualMachine -VM $VM | convertto-json"                    #Command to run
...
@log.trace("Finished executing 'fb-cloud:scvmm:operation:resume_virtual_machine.rb' flintbit...")
#end
