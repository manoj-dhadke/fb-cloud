...
require 'rubygems'
#begin
@log.trace("Started executing 'fb-cloud:scvmm:operation:start_virtual_machine.rb' flintbit...")
begin
...
@log.trace("Finished executing 'fb-cloud:scvmm:operation:start_virtual_machine.rb' flintbit...")
#end
