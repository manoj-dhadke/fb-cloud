...
Description - To Remove a VM
*/

//begin
log.trace("Started executing 'fb-cloud:scvmm:operation:remove_virtual_machine.groovy' flintbit...")
try{
...
log.trace("Finished executing 'fb-cloud:scvmm:operation:remove_virtual_machine.groovy' flintbit...")
//end