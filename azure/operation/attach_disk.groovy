 ...
 */
log.trace("Started executing 'fb-cloud:azure:operation:attach_disk.groovy' flintbit...")
try{
// Flintbit Input Parameters
    ...
    data_disk_size = input.get("data-disk-size")
   ...
   if (connector_name == null || connector_name == ""){
      ...
      connector_call = call.connector(connector_name)
                            ...
                            .set('data-disk-size', data_disk_size)
...
log.trace("Finished executing 'fb-cloud:azure:operation:attach_disk.groovy' flintbit")                         