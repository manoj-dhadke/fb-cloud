# begin
@log.trace("Started executing 'fb-cloud:azure:operation:list_instance.rb' flintbit...")
begin
    ...
    if @connector_name.nil? || @connector_name.empty?
        raise 'Please provide "MS Azure connector name (connector_name)" to get instance list'
    end
...
@log.trace("Finished executing 'fb-cloud:azure:operation:list_instance.rb' flintbit")
# end
