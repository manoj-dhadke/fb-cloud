...
# begin
@log.trace("Started executing 'fb-cloud:azure:operation:list_region.rb' flintbit...")
begin
...
@log.trace("Finished executing 'fb-cloud:azure:operation:list_region.rb' flintbit")
# end
