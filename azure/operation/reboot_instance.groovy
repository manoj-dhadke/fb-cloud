// begin
log.trace("Started executing 'fb-cloud:azure:operation:reboot_instance.groovy' flintbit...")
try{
...
log.trace("Finished executing 'fb-cloud:azure:operation:reboot_instance.groovy' flintbit")
// end
