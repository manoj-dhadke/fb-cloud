# begin
require 'json'
@log.trace("Started executing 'azure:list_security_group.rb' flintbit...")
begin
   ...
   connector_call = @call.connector(@connector_name)
    ...
    @log.info("security_group_list---------#{security_group_list}")
...
@log.trace("Finished executing 'azure:list_security_group.rb' flintbit")
# end
