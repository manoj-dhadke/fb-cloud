# begin
@log.trace("Started executing 'fb-cloud:azure:operation:start_instance.rb' flintbit...")
begin
    ...
    if @connector_name.nil? || @connector_name.empty?
        raise 'Please provide "MS Azure connector name (connector_name)" to start Instance'
    end

    if @name.nil? || @name.empty?
        raise 'Please provide "Azure instance name (name) to start Instance'
    else
...
@log.trace("Finished executing 'fb-cloud:azure:operation:start_instance.rb' flintbit")
# end
