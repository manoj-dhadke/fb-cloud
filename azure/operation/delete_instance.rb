# begin
@log.trace("Started executing 'fb-cloud:azure:operation:delete_instance.rb' flintbit...")
begin
...
@log.trace("Finished executing 'fb-cloud:azure:operation:delete_instance.rb' flintbit")
# end
