...
begin
    ...
    if @connector_name.nil? || @connector_name.empty?
        raise 'Please provide "MS Azure connector name (connector_name)" to create resource group'
    end
...
@log.trace("Finished executing 'fb-cloud:azure:operation:create_resource_group.rb.rb' flintbit")
# end
