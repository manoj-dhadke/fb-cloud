# begin
require 'json'
@log.trace("Started executing 'fb-cloud:azure:operation:delete_network_by_id.rb' flintbit...")
begin
   ...
   if @network_id.nil? || @network_id.empty?
       raise 'Please provide "MS Azure network id(network_id)" to delete network'
   end
...
@log.trace("Finished executing 'fb-cloud:azure:operation:delete_network_by_id.rb' flintbit")
# end
