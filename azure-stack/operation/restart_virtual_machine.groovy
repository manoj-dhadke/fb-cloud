log.trace("Started executing 'fb-cloud:azure-stack:operation:restart_virtual_machine.groovy' flintbit...")
    ...
    if (import_exitcode == 0){
	     ...
	     login_command="cd C:\\AzureStack-Tools-master; .\\azureimport_script2.ps1 ${subscription_name} ${tenant_username} ${tenant_password} ${aadtenant_name};.\\restartazurestackvm.ps1 ${virtual_machine_name} ${resource_group_name}  2>&1|convertto-json"
...
log.trace("Finished executing 'fb-cloud:azure-stack:operation:restart_virtual_machine.groovy' flintbit...")