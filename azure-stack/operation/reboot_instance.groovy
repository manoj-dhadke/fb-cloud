// begin
log.trace("Started executing 'fb-cloud:azure-stack:operation:reboot_instance.groovy' flintbit...")
try{
    // Flintbit Input Parameters
    // Mandatory
    connector_name = input.get('connector_name')
    action = 'as-reboot-instance'
    ...
    if (arm_endpoint == null || arm_endpoint  ==""){
        throw new Exception('Please provide "Azure ARM Endpoint (arm_endpoint) to reboot Instance')
    }
    else{
...
log.trace("Finished executing 'fb-cloud:azure-stack:operation:reboot_instance.groovy' flintbit")
// end
