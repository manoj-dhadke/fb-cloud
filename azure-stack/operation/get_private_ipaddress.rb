...
require 'rubygems'
#begin
@log.trace("Started executing 'fb-cloud:azure-stack:operation:get_private_ipaddress.rb' flintbit...")
begin
...
@log.trace("Finished executing 'fb-cloud:azure-stack:operation:get_private_ipaddress.rb' flintbit...")
#end
