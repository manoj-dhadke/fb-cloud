...
require 'rubygems'
#begin
@log.trace("Started executing 'fb-cloud:azure-stack:operation:get_power_status_of_vm.rb' flintbit...")
begin
    ...
    if import_exitcode == 0       
		...
		if exception.nil?
			 ...
			 @output.set('exit-code', 0).set('message', login_azure_stack.message).set('power-status',result.to_s)	    
...
@log.trace("Finished executing 'fb-cloud:azure-stack:operation:get_power_status_of_vm.rb' flintbit...")
#end
