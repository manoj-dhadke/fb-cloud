...
$StorageAccountName = "sto$(Get-Random)"
...
$nsg = New-AzureRmNetworkSecurityGroup `
  -ResourceGroupName $ResourceGroupName `
  -Location $location `
  -Name "networksecuritygroup$(Get-Random)" `

# Create a virtual network card and associate it with public IP address and NSG
$nic = New-AzureRmNetworkInterface `
  -Name "nicname$(Get-Random)" `
  -ResourceGroupName $ResourceGroupName `
  -Location $location `
...
$UserName= "cloudifyasia"
$Password= "CAP@ssw0rd123"| ConvertTo-SecureString -Force -AsPlainText
$Credential=New-Object PSCredential($UserName,$Password)

# Create the virtual machine configuration object
$VmName = "CentOS-server$(Get-Random)"
$VmSize = $customVMsize
