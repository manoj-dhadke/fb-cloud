 ...
 */
log.trace("Started executing 'fb-cloud:azure-stack:operation:list_volumes.groovy' flintbit...")
try{
   ...
   connector_call = call.connector(connector_name)
    ...
    log.info("Response of list disks ${response.toString()}")
...
log.trace("Finished executing 'fb-cloud:azure-stack:operation:list_volumes.groovy' flintbit")
