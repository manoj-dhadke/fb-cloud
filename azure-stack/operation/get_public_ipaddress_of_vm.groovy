log.trace("Started executing 'fb-cloud:azure-stack:operation:get_public_ipaddress_of_vm.groovy' flintbit...")
try{
...
log.trace("Finished executing 'fb-cloud:azure-stack:operation:get_public_ipaddress_of_vm.groovy' flintbit...")