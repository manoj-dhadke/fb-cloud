...
require 'rubygems'
#begin
@log.trace("Started executing 'fb-cloud:azure-stack:operation:get_virtual_machine_details.rb' flintbit...")
begin
...
@log.trace("Finished executing 'fb-cloud:azure-stack:operation:get_virtual_machine_details.rb' flintbit...")
#end
