...
require 'rubygems'
#begin
@log.trace("Started executing 'fb-cloud:azure-stack:operation:start_virtual_machine.rb' flintbit...")
begin
...
@log.trace("Finished executing 'fb-cloud:azure-stack:operation:start_virtual_machine.rb' flintbit...")
#end
