log.trace("Started executing 'fb-cloud:azure-stack:operation:start_virtual_machine.groovy' flintbit...")
...
log.trace("Finished executing 'fb-cloud:azure-stack:operation:start_virtual_machine.groovy' flintbit...")