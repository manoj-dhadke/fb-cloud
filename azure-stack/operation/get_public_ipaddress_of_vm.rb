...
require 'rubygems'
#begin
@log.trace("Started executing 'fb-cloud:azure-stack:operation:get_public_ipaddress_of_vm.rb' flintbit...")
begin
...
@log.trace("Finished executing 'fb-cloud:azure-stack:operation:get_public_ipaddress_of_vm.rb' flintbit...")
#end
