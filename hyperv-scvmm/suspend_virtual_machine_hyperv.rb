...
require 'rubygems'
#begin
@log.trace("Started executing 'fb-cloud:hyperv:operation:suspend_virtual_machine_hyperv.rb' flintbit...")
begin
...
@log.trace("Finished executing 'fb-cloud:hyperv:operation:suspend_virtual_machine_hyperv.rb' flintbit...")
#end
