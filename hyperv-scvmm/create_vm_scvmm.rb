...
require 'rubygems'
#begin
@log.trace("Started executing 'fb-cloud:hyperv:operation:create_vm_scvmm.rb' flintbit...")
begin
    #Flintbit Input Parameters
    #Mandatory  
    @connector_name= @input.get("connector_name")                             #Name of the Connector
    @action="clone-vm-scvmm"
    @vm_name= @input.get("vm-name")
    @vm_host_name= @input.get("vm-host-name")
    @vm_template_name= @input.get("vm-template-name")
    @vm_path= @input.get("vm-path")   
    ...
    connector_call = @call.connector(@connector_name)
	            .set("vm-name",@vm_name)
	            .set("vm-host-name",@vm_host_name)
	            .set("vm-path",@vm_path)
	            .set("vm-template-name",@vm_template_name)
                    .set("target",@target)
...
@log.trace("Finished executing 'fb-cloud:hyperv:operation:create_vm_scvmm.rb' flintbit...")
#end
