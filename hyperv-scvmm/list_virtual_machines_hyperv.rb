...
require 'rubygems'
#begin
@log.trace("Started executing 'fb-cloud:hyperv:operation:list_virtual_machines_hyperv.rb' flintbit...")
begin
...
@log.trace("Finished executing 'fb-cloud:hyperv:operation:list_virtual_machines_hyperv.rb' flintbit...")
#end
