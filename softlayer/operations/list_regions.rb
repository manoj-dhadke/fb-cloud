#begin
@log.trace("Started executing 'flint-cloud:softlayer:operation:list_regions.rb' flintbit...")
...
@log.trace("Finished executing 'flint-cloud:softlayer:operation:list_regions.rb' flintbit...")
#end
