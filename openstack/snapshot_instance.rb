# begin
@log.trace("Started executing 'flint-cloud:openstack-openstackClientV2:operation:creatsnapshot_openstack_instance.rb' flintbit...")
begin
    ...
    if connector_name.nil? || connector_name.empty?
        raise 'Please provide "openstack connector name (connector_name)" to stop server'
        end
    ...
    if @snapshotname.nil? || @snapshotname.empty?
        raise 'Please provide "openstack snapshot name (name)" to createsnapshot server'
    else
...
@log.trace("Finished executing 'flint-cloud:openstackClientV2:operation:createsnapshot_openstack_instance.rb' flintbit")
# end
