# begin
@log.trace("Started executing 'fb-cloud:openstack:operation:rename_instance.rb' flintbit...")
begin
...
@log.trace("Finished executing 'fb-cloud:openstack:operation:rename_instance.rb' flintbit")
# end
