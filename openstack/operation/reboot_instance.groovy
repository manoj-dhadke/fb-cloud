 ...
 */
log.trace("Started executing 'fb-cloud:openstack:operation:reboot_instance.groovy' flintbit...")
...
log.trace("Finished executing 'fb-cloud:openstack:operation:reboot_instance.groovy' flintbit")
