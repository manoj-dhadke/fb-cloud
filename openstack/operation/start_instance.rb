# begin
@log.trace("Started executing 'fb-cloud:openstack:operation:start_instance.rb' flintbit...")
begin
    ...
    if @target.nil? || @target.empty?
     ...
     if @username.nil? || @username.empty?
        raise 'Please provide "openstack username (@username)" to start instance'
    end

    if @password.nil? || @password.empty?
        raise 'Please provide "openstack password (@password)"  to start instance'
    end

     if @serverId.nil? || @serverId.empty?
        raise 'Please provide "openstack server-id (@@serverId)"  to start instance'
    end
...
@log.trace("Finished executing 'fb-cloud:openstack:operation:start_instance.rb' flintbit")
# end
