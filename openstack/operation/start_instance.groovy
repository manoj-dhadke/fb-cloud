log.trace("Started executing 'fb-cloud:openstack:operation:start_instance.groovy' flintbit...")
try{
...
log.trace("Finished executing 'fb-cloud:openstack:operation:start_instance.groovy' flintbit")
