log.trace("Started executing 'fb-cloud:openstack:operation:resume_instance.groovy' flintbit...")
try{
    ...
    {
        throw 'Please provide "openstack server-id (serverId)"  to start instance'
...
log.trace("Finished executing 'fb-cloud:openstack:operation:resume_instance.groovy' flintbit")
