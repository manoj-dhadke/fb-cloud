# begin
@log.trace("Started executing 'fb-cloud:openstack:operation:unpause_instance.rb' flintbit...")
begin
    ...
    if connector_name.nil? || connector_name.empty?
        raise 'Please provide "openstack connector name (connector_name)" to unpause instance'
    end
...
@log.trace("Finished executing 'fb-cloud:openstack:operation:unpause_instance.rb' flintbit")
# end
