# begin
@log.trace("Started executing 'flint-cloud:openstack-openstackClientV2:operation:start_openstack_instance.rb' flintbit...")
begin
...
@log.trace("Finished executing 'flint-cloud:openstackClientV2:operation:start_openstack_instance.rb' flintbit")
# end
